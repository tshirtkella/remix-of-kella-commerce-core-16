    ...
    : [
        {
          ...
          subtitle: "On all t-shirts & casual wear — limited time only!",
          discount: "BUY 1 GET 1",
          bg: "linear-gradient(135deg, #DC2626 0%, #EF4444 40%, #F87171 100%)",
          text: "#FFFFFF",
          cta: "Grab the Deal",
          link: "/shop",
          image: null,
        ...
        },
        {
          ...
          subtitle: "Fresh everyday deals on premium brands you love",
        ...
        },
        {
          ...
          subtitle: "Be the first to explore the latest trending collection",
        ...
        },
        {
          ...
          subtitle: "No minimum order — free shipping on everything this week!",
        ...
        },
        {
          ...
          subtitle: "Massive discounts every Friday — don't miss out!",
